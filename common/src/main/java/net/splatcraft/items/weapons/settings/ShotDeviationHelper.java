...
public class ShotDeviationHelper
{
    ...
    {
        SplatcraftComponents.ShotDeviationData deviationData = getDeviationData(stack);
    ...
    public static SplatcraftComponents.ShotDeviationData getDeviationData(ItemStack stack)
    {
    ...
    {
        SplatcraftComponents.ShotDeviationData nbt = getDeviationData(stack);
