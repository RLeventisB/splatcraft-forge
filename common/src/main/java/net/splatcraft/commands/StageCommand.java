...
public class StageCommand
{
            ...
            .then(CommandManager.literal("play")
                .then(stageId("stage")
                    ...
                    .then(CommandManager.argument("players", EntityArgumentType.players())
                        ...
                        .then(CommandManager.argument("gamemode", StageGameMode.ArgumentType.argument())
    ...
    {
        return playStage(context.getSource(), StringArgumentType.getString(context, "stage"), EntityArgumentType.getPlayers(context, "players"), BoolArgumentType.getBool(context, "assignTeams"), context.getArgument("gamemode", StageGameMode.class));
    }
