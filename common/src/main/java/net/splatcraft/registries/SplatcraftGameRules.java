...
public class SplatcraftGameRules
{
	...
	public static boolean getBooleanRuleValue(Level world, GameRules.Key<GameRules.BooleanValue> rule)
	{
		return world.isClientSide() ? getClientsideBooleanValue(rule) : world.getGameRules().getBoolean(rule);
	}
	public static int getIntRuleValue(Level world, GameRules.Key<GameRules.IntegerValue> rule)
	{
		return world.isClientSide() ? getClientsideIntValue(rule) : world.getGameRules().getInt(rule);
	}
