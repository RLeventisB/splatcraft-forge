...
public class InkColorRegistry
{
     ...
     * @return The corresponding {@link InkColor}, or {@code InkColor.DEFAULT} if the value wasn't a valid {@link Identifier}, or was not registered, or the text wasn't a valid hex color.
     */
