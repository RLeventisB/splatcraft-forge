...
public class SplatcraftTags
{
	...
	{
		public static final HashMap<InkTankItem, TagKey<Item>> TANK_WHITELIST_TAG_MAP = new HashMap<>();
		public static final HashMap<InkTankItem, TagKey<Item>> TANK_BLACKLIST_TAG_MAP = new HashMap<>();
		...
		{
			if (!TANK_WHITELIST_TAG_MAP.containsKey(tank))
			{
				TANK_WHITELIST_TAG_MAP.put(tank, createTag(name + "_whitelist"));
			}
			if (!TANK_BLACKLIST_TAG_MAP.containsKey(tank))
			{
				TANK_BLACKLIST_TAG_MAP.put(tank, createTag(name + "_blacklist"));
			}
		}
