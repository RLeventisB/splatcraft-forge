...
//            for (int y = chunkMinY; y <= chunkmaxY; y++)
    ...
    {
        return ChunkInkCapability.get(world, pos).isInked(RelativeBlockPos.fromAbsolute(pos), index);
    }

    public static boolean isInkedAny(World world, BlockPos pos)
    {
        return ChunkInkCapability.get(world, pos).isInkedAny(RelativeBlockPos.fromAbsolute(pos));
    }
