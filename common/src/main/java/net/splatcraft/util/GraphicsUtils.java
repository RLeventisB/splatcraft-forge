...
{
	public static void drawTexture(GuiGraphics graphics, ResourceLocation pAtlasLocation, float pX, float pY, float pUOffset, float pVOffset, int pUWidth, int pVHeight)
	{
		drawTexture(graphics, pAtlasLocation, pX, pY, 0, pUOffset, pVOffset, pUWidth, pVHeight, 256, 256);
	}
	public static void drawTexture(GuiGraphics graphics, ResourceLocation pAtlasLocation, float pX, float pY, float pBlitOffset, float pUOffset, float pVOffset, float pUWidth, float pVHeight, float pTextureWidth, float pTextureHeight)
	{
	...
	public static void drawTexture(GuiGraphics graphics, ResourceLocation pAtlasLocation, float pX, float pY, float pWidth, float pHeight, float pUOffset, float pVOffset, float pUWidth, float pVHeight, float pTextureWidth, float pTextureHeight)
	{
	...
	public static void drawTexture(GuiGraphics graphics, ResourceLocation pAtlasLocation, float pX, float pY, float pUOffset, float pVOffset, float pWidth, float pHeight, float pTextureWidth, float pTextureHeight)
	{
		drawTexture(graphics, pAtlasLocation, pX, pY, pWidth, pHeight, pUOffset, pVOffset, pWidth, pHeight, pTextureWidth, pTextureHeight);
	}
	public static void drawTexture(GuiGraphics graphics, ResourceLocation pAtlasLocation, float pX1, float pX2, float pY1, float pY2, float pBlitOffset, float pUWidth, float pVHeight, float pUOffset, float pVOffset, float pTextureWidth, float pTextureHeight)
	{
	...
	public static void innerBlit(GuiGraphics graphics, ResourceLocation pAtlasLocation, float pX1, float pX2, float pY1, float pY2, float pBlitOffset, float pMinU, float pMaxU, float pMinV, float pMaxV)
	{
		...
		bufferbuilder.addVertex(matrix4f, pX1, pY1, pBlitOffset).setUv(pMinU, pMinV); // if this can handle ints, then why not lol
