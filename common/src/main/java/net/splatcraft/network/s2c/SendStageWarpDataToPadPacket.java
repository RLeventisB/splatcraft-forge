...
{
	public static final Type<? extends CustomPacketPayload> ID = CommonUtils.createIdFromClass(SendStageWarpDataToPadPacket.class);
	...
	public static SendStageWarpDataToPadPacket decode(RegistryFriendlyByteBuf buffer)
	{
