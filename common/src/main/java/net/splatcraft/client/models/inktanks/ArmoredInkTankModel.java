...
public class ArmoredInkTankModel extends AbstractInkTankModel
{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Splatcraft.identifierOf("armored_ink_tank"), "main");
	...
	{
		if (contextModel instanceof HumanoidModel<?> bipedModel)
		{
			leftArm.yRot = bipedModel.leftArm.yRot;
			leftArm.xRot = bipedModel.leftArm.xRot;
			leftArm.zRot = bipedModel.leftArm.zRot;
			rightArm.yRot = bipedModel.rightArm.yRot;
			rightArm.xRot = bipedModel.rightArm.xRot;
			rightArm.zRot = bipedModel.rightArm.zRot;
		}
	}
}