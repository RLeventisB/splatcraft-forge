...
public class ClassicInkTankModel extends AbstractInkTankModel
{
    ...
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Splatcraft.identifierOf("classicinktankmodel"), "main");
    ...
    public static TexturedModelData createBodyLayer()
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            Ink_Tank.addChild("InkPiece_" + i, ModelPartBuilder.create().uv(52, 0)
