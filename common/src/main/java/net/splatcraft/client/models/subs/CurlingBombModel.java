...
public class CurlingBombModel extends AbstractSubWeaponModel<CurlingBombEntity>
{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Splatcraft.identifierOf("curlingbombmodel"), "main");
	...
	public void prepareMobModel(@NotNull CurlingBombEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick)
	{
		...
		top.y = 20 - Mth.clamp(Mth.lerpInt(partialTick, entityIn.prevFuseTime, entityIn.fuseTime) - 50, 0, .95f) * 3f;
	}
	@Override
