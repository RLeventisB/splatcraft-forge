...
public class InkTankJrModel extends AbstractInkTankModel
{
    ...
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Splatcraft.identifierOf("inktankjrmodel"), "main");
    ...
    public static TexturedModelData createBodyLayer()
    {
        ...
        Torso.addChild("Tag", ModelPartBuilder.create(), ModelTransform.of(-3.1168F, 2.8445F, 8.9821F, -0.1309F, -0.3927F, -0.3054F));

        for (int i = 0; i < 7; i++)
        {
            Ink_Tank.addChild("InkPiece_" + i, ModelPartBuilder.create().uv(110, 0)
