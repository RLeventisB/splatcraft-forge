...
public class InkSquidRenderer extends LivingEntityRenderer<LivingEntity, InkSquidModel> implements FeatureRendererContext<LivingEntity, InkSquidModel>
{
	...
	@Override
	public void render(@NotNull LivingEntity entity, float p_115309_, float partialTicks, @NotNull MatrixStack poseStack, @NotNull VertexConsumerProvider bufferSource, int light)
	{
