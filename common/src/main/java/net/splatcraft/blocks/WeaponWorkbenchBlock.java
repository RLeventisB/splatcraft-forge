...
public class WeaponWorkbenchBlock extends HorizontalFacingBlock implements Waterloggable
{
    ...
    {
        return new SimpleNamedScreenHandlerFactory((id, inventory, player) -> new WeaponWorkbenchContainer(inventory, ScreenHandlerContext.create(levelIn, pos), id), CONTAINER_NAME);
    }
