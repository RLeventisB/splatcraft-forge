...
public class SquidBumperEntity extends LivingEntity implements IColoredEntity
{
	...
	{
		CommonUtils.blockDrop(getWorld(), getBlockPos(), ColorUtils.withColorLocked(ColorUtils.withInkColor(new ItemStack(SplatcraftItems.squidBumper.get()), getColor()), true));
	}
	@Override
