...
)
{
	public static final Codec<DamageRangesRecord> CODEC = RecordCodecBuilder.create(
		instance -> instance.group(
			// tried to use Codec.pair(Codec.FLOAT.fieldOF("max_range"), Codec.FLOAT.fieldOf("damage")) but for the life of me i couldnt because it wasnt a JSON object????? how does this work
