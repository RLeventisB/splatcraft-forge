...
public class InkDropRenderer extends EntityRenderer<InkDropEntity> implements RenderLayerParent<InkDropEntity, InkDropModel>
{
	...
	@Override
	public void render(InkDropEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn)
	{
	...
	@Override
	public InkDropModel getModel()
	{
		return MODEL;
	}

	@Override
	public ResourceLocation getTextureLocation(InkDropEntity entity)
	{
