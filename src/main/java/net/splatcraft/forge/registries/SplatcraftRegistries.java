...
public class SplatcraftRegistries
{
	public static void register()
	{
		...
		SplatcraftItemGroups.CREATIVE_MODE_TABS.register(FMLJavaModLoadingContext.get().getModEventBus());
//		SplatcraftInkColors.REGISTRY.register(FMLJavaModLoadingContext.get().getModEventBus());
...
//		SplatcraftSounds.register((resourceLocation, v) -> forgeEvent.register((ResourceKey<? extends Registry<SoundEvent>>) registryKey, resourceLocation, () -> v));
	}
}
